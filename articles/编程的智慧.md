...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>void fooMacOS() {
  a();
  c();
  d();
}
...
<p>和</p>
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>void fooOther() {
  b();
  c();
  e();
}
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>void preFoo() {
  a();
  b()
  c();
</code></pre></div>    </div>
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code> String findX() {
    ...
    x = ...;
    return x;
 }
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>// put elephant1 into fridge2
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>boolean successInDeleteFile = deleteFile("foo.txt");
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>boolean success = deleteFile("foo.txt");
if (success) {
  ...
} else {
  ...
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>String msg;
if (...) {
  msg = "succeed";
  log.info(msg);
} else {
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>void put(Elephant elephant, Fridge fridge) {
  openDoor(fridge);
  if (elephant.alive()) {
    ...
  } else {
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>Pizza pizza = makePizza(crust(salt(), butter()),
   topping(onion(), tomato(), sausage()));
</code></pre></div>    </div>
<p>这样的代码一行太长，而且嵌套太多，不容易看清楚。其实训练有素的函数式程序员，都知道中间变量的好处，不会盲目的使用嵌套的函数。他们会把这代码变成这样：</p>
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>Crust crust = crust(salt(), butter());
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>   if (someLongCondition1() &amp;&amp; someLongCondition2() &amp;&amp; someLongCondition3() &amp;&amp;
     someLongCondition4()) {
     ...
   }
</code></pre></div></div>
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>   if (someLongCondition1() &amp;&amp;
       someLongCondition2() &amp;&amp;
       someLongCondition3() &amp;&amp;
       someLongCondition4()) {
     ...
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>   log.info("failed to find file {} for command {}, with exception {}", file, command,
     exception);
</code></pre></div></div>
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>   log.info("failed to find file {} for command {}, with exception {}",
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>expect(foo).to.be.a('string');
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>List&lt;String&gt; goodNames = new ArrayList&lt;&gt;();
...
<p>比如下面这段代码：</p>
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>while (condition1) {
  ...
  if (condition2) {
    break;
  }
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>while (condition1 &amp;&amp; !condition2) {
  ...
}
</code></pre></div>    </div>
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>public boolean hasBadName(List&lt;String&gt; names) {
...
<p>由于Shell语言的逻辑操作<code class="language-plaintext highlighter-rouge">a &amp;&amp; b</code>具有“短路”的特性，如果<code class="language-plaintext highlighter-rouge">a</code>等于false，那么<code class="language-plaintext highlighter-rouge">b</code>就没必要执行了。这就是为什么当command1成功，才会执行command2，当command2成功，才会执行command3。同样，</p>
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>command1 || command2 || command3
</code></pre></div></div>
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>if (action1() || action2() &amp;&amp; action3()) {
  ...
}
</code></pre></div></div>
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>if (!action1()) {
  if (action2()) {
    action3();
  }
}
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>String s = "";
if (x &lt; 5) {
  s = "ok";
}
</code></pre></div></div>
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>String s = x &lt; 5 ? "ok" : "";
</code></pre></div></div>
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>String foo() throws MyException {
  ...
}
</code></pre></div></div>
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>public String find() throws NotFoundException {
  if (...) {
    return ...;
  } else {
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>public String foo() {
  String found = find();
  if (found == null) {
    return null;
  }
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>public void foo(A a, B b, C c) {
  if (a == null) { ... }
  if (b == null) { ... }
  if (c == null) { ... }
  ...
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>public static &lt;T&gt; T requireNonNull(T obj) {
  if (obj == null) {
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>let found = find()
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>Optional&lt;String&gt; found = find();
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>public static String foo() {
  String found = find();
  if (found != null) {
    return found;
  } else {
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>Option&lt;String&gt; found = find();
if (found.isPresent()) {
